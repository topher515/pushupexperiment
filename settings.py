# Django settings for thepushupexperiment project.
import os
...
MEDIA_ROOT = os.path.join(DIRNAME,'public','media')
...
SECRET_KEY = '3-4pftnihcf)-1t$0m%xb5sg8hh!r1$zxmr=ic!_yamy^w-e!u'
